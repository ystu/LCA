...
public class AlgoFPGrowth {
	 ...
	 */
	public Itemsets runAlgorithm(double minsup, ArrayList<int[]> originalData) throws FileNotFoundException, IOException {
		// record start time
		...
		scanDatabaseToDetermineFrequencyOfSingleItems(originalData, mapSupport);
		
		// convert the minimum support as percentage to a
		// relative minimum support
		this.relativeMinsupp = (int) Math.ceil(minsup * originalData.size());
...
//			Set<Integer> alreadySeen = new HashSet<Integer>();
	 ...
	 * @param originalData the path of the input file
	 * @param mapSupport a map for storing the support of each item (key: item, value: support)
	 * @throws IOException  exception if error while writing the file
	 */
	private void scanDatabaseToDetermineFrequencyOfSingleItems(ArrayList<int[]> originalData,
